If you are to test this application extensively, please acquire your own personal OMDB key at omdbapi.com and add it in the application.yml file of the omdb-service application.
